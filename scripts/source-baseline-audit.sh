...
run_self_test() {
  ...
  assert_policy "desktop/renderer/node_modules/typescript/lib/tsc.js" "denied" "dependency-cache-runtime-or-generated-tree"
  assert_policy "desktop/renderer/.env.local" "denied" "live-config-or-environment"
