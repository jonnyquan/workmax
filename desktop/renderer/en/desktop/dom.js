...
export const mindEditForm = document.querySelector("#mind-edit-form");
export const mindEditName = document.querySelector("#mind-edit-name");
export const mindEditRole = document.querySelector("#mind-edit-role");
export const mindEditModel = document.querySelector("#mind-edit-model");
