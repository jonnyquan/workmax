...
if [ "$require_renderer" -eq 1 ]; then
  ...
  for required in index.html styles.css renderer.js dom.js fence.js protocol.js events.js markdown.js transcript.js composer.js threads.js context-panel.js mind.js shim.js lib/desktop-bridge.js; do
  ...
  while IFS= read -r file; do
    rel="${file#"$renderer/"}"
    case "$rel" in
      index.html|styles.css|renderer.js|dom.js|fence.js|protocol.js|events.js|markdown.js|transcript.js|composer.js|threads.js|context-panel.js|mind.js|shim.js|lib/desktop-bridge.js) ;;
